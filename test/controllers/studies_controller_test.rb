...
class StudiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create study" do
    assert_difference('Study.count') do
      post studies_url, params: { study: { enddate: @study.enddate, grade: @study.grade, initdate: @study.initdate, title: @study.title, user_id: @study.user_id } }
    end
  ...
  test "should update study" do
    patch study_url(@study), params: { study: { enddate: @study.enddate, grade: @study.grade, initdate: @study.initdate, title: @study.title, user_id: @study.user_id } }
